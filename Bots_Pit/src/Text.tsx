...
const conc: Article = {title: "Заключение",
    text: '"Роботы и Яма" предлагает игрокам уникальный опыт управления роботом в постапокалиптическом подземном комплексе. Игра сочетает в себе увлекательный сюжет, сложные головоломки и оригинальную боевую систему, что делает её привлекательной для широкой аудитории. Разнообразие концовок добавляет глубину игровому процессу.'}
